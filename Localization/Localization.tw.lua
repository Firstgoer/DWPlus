if GetLocale() == "zhTW" then
  ...
  core.L = {
    ...
    強烈建議您僅在希望限制哪些警官需要權限的情況下才使用此白名單設置。如果您希望所有人員都具有權限，請完全忽略此設置功能。請謹慎使用。 （如果應用這些設置會導致問題，請使用文本編輯器打開 \WTF\Accounts\ACCOUNT_NAME\SavedVariables\DWPlus.lua文件，然後刪除底部附近的MonDKP_Whitelist表。）]=],
    WIPETABLES = "擦桌子",
