...
core.L = {
  ...
  ADDITEMSTOBIDWINDOW   = "Add items from bags",
  ADDITEMSTOBIDWINDOWDESC = "Only non-personal items with \"Rare\" quality or higher will be added",
  ...
  CONFIRMBIDDINGCLEAAR  = "Are you sure you'd like to clear the bidding list?",
  CONGRATS              = "Congrats",
  ...
  CONSULDIALOGHEADER    = "Send consul info to chat",
  CONSULEXISTS          = "Consul record already exists",
  CONSULMODAL           = "Print consul items info for zone",
  CONSULLOOT            = "Consul loot",
  CONSULFOUND           = "Found %d consul loot entries. |cff00cc66|Hdwp:showConsul|h[Share]|h|r";
  CONSULPRINT           = "|cff00cc66Consul: %s|cff00cc66 is reserved for %s",
  CONSULPRINTEMPTY      = "|cff00cc66Consul: %s|cff00cc66 is custom defined",
  ...
  DELETEDKPENTRY        = "Delete RP Entry",
  DELETECONSUL          = "Delete Consul Entry",
  DELETERECEIVEDCONSUL  = "|cff00cc66Player %s|cff00cc66 just received item %s|cff00cc66. Do you want to |cffff0000|Hdwp:deleteConsul:%s:%s|h[Remove]|h|r|cff00cc66 consul entry?",
  ...
  INVALIDPLAYER         = "Player not found in RP table.",
  ...
  LMBREMOVE         = "Right Click To Delete Entry",
  ...
  MINIMAPLEFTCLICK      = "LMB",
  MINIMAPRIGHTCLICK     = "RMB",
  MINIMAPSETTINGS       = "Open DWPlus settings",
  MINIMAPTOGGLE         = "Toggle minimap button",
  MINIMAPRESET          = "Reset minimap button",
  ...
  DWPSCALESIZE       = "DWPlus Scale Size",
  DWPSCALESIZETTDESC = "Scale of the DWPlus window. Click \"Save Settings\" to change size to set value.",
  ...
  OUTOFDATEANNOUNCE     = "Your version of DWPlus is out-of-date. Please update on Curse/Twitch or WoWInterface to ensure there are no compatibility issues.",
  ...
  SEARCHCONSULDESC      = "Filters consul table by item. Search is available by part of item name or by id.",
  SECONDBIDDER          = "Second Bidder",
  SECONDS               = "Seconds",
  SELECTALL             = "Select All",
  SELECTALLVISIBLE      = "Select All Visible",
  SELECTBID             = "Select item for start bidding",
  ...
  CHANGELOG0            = "",
  CHANGELOG1            = "Version 1.1.1:",
  CHANGELOG2            = "- Added consul loot tab filters",
  CHANGELOG3            = "- Added some consul notifications",
  CHANGELOG4            = "- Update addon for 1.13.6 version of World of Warcraft",
  CHANGELOG5            = "",
  CHANGELOG6            = "Version 1.1.2:",
  CHANGELOG7            = "- Added new select item for bidding window. Looted items will be added here automatically. Clears on reload. Bidding window can be cleared and populated from bags",
  CHANGELOG8            = "",
  CHANGELOG9            = "",
  CHANGELOG10           = "",
}