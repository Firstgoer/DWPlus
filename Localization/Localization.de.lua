if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    DWPSCALESIZETTDESC = "Maßstab des Monolith DKP-Fensters. Klicken Sie auf \"Save Settings\" (Einstellungen speichern), um die Größe auf den eingestellten Wert zu ändern.",
    DWPSCALESIZETTWARN = "Möglicherweise ist ein / reload nach dem Speichern erforderlich, wenn ein anderes Addon verwendet wird, das die Skalierung der Benutzeroberfläche ändert (z. B. TukUI, ElvUI usw.).",
    MORE = "Mehr",
    ...
    TOTALDWPUSERS = "Gesamtzahl der DWP-Benutzer",
